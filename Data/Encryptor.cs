...
{
    /// <summary>
    /// Provides encryption functionality used by the ASP.NET services.
    /// </summary>
    public class Encryptor
    {

        /// <summary>
        /// Computes the hash value for the specified <c>System.String</c>.
        /// </summary>
        /// <param name="plainText">The data to compute the hash for.</param>
        /// <param name="hashAlgorithm">The hashing algorithm to use.</param>
        /// <param name="saltBytes">The has salt.</param>
        ...
        /// </summary>
        /// <param name="plainText">The hash value of the data to be signed. </param>
        /// <param name="hashAlgorithm">The signature data to be verified. </param>
        /// <param name="hashValue">The base-64 hashed string value. </param>
